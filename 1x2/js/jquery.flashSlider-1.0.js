    ...
    $.fn.flashSlider = function(options) {
        ...
        this.each(function() {
            ...
            if (options.controlsShow) {
				 $("#index_flash_button li").hover(function() {
                    var num = $(this).html();
                    flash(num, true);
                }, function() {
            ...
            function setcurrnum(index) {
                obj.find("#index_flash_button li").eq(index).addClass('active').siblings().removeClass('active');
            }
			function select_flash (id){
				$("#index_flash_bottom_"+id).addClass('active').siblings().removeClass('active');
				$("#index_flash_button_"+id).addClass('active').siblings().removeClass('active');
			}
