    ...
    $.fn.flashSlider = function(options) {
        ...
        this.each(function() {
            ...
            if (options.controlsShow) {
				 $("#category_banner_button li").hover(function() {
                    var num = $(this).html();
                    flash(num, true);
                }, function() {
            ...
            function setcurrnum(index) {
                obj.find("#category_banner_button li").eq(index).addClass('active').siblings().removeClass('active');
            }
			function select_flash (id){
				$("#category_banner_r_top_"+id).addClass('active').siblings().removeClass('active');
				$("#category_banner_r_m_"+id).addClass('active').siblings().removeClass('active');
				$("#category_banner_r_b_"+id).addClass('active').siblings().removeClass('active');
			}
